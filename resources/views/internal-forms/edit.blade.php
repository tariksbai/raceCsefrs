...
@section('title', 'Modifier le formulaire interne')

@section('page-title', 'Modifier le formulaire interne')
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('admin.internal-forms.update', $form) }}">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                        <option value="draft" {{ old('status', $form->status) === 'draft' ? 'selected' : '' }}>Brouillon</option>
                ...
                <div class="col-md-4 mb-3 d-flex align-items-end">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="allow_anonymous" id="allow_anonymous" value="1" {{ old('allow_anonymous', $form->allow_anonymous) ? 'checked' : '' }}>
