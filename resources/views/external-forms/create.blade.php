...
@section('title', 'Ajouter un formulaire externe')

@section('page-title', 'Ajouter un formulaire externe')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2>Ajouter un formulaire externe</h2>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('admin.external-forms.store') }}">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    ...
                    <textarea name="iframe_code" id="iframe_code" rows="4" class="form-control @error('iframe_code') is-invalid @enderror" style="font-family: monospace;">{{ old('iframe_code') }}</textarea>
                    @error('iframe_code')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
